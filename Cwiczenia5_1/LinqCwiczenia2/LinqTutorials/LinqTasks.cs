...
namespace LinqTutorials
{
    public static class LinqTasks
    {
        ...
        {
            IEnumerable<Emp> result = Emps.Where(e => e.Job == "Backend programmer" && e.Salary > 1000); ;
            return result;
        }
        ...
        {
            int result = Emps.OrderByDescending(e => e.Salary).First().Salary;
            return result;
        }
        ...
        {
            IEnumerable<Emp> result = Emps.Where(e => e.Salary == Emps.OrderByDescending(e => e.Salary).First().Salary);
            return result;
        }
        ...
        {
            Emp result = (Emp) Emps.Where(e => e.Job == "Frontend programmer")
        ...
        public static IEnumerable<object> Task10()
        {
            ...
            var tempList = new List<Object> { tempValue };
        ...
        public static IEnumerable<object> Task11()
        {
            ...
            IEnumerable<object> result = from d in Depts
                                         from e in Emps
                                         where d.Deptno == e.Deptno
                                         group e by e.Job into empJob
                                         where empJob.Count() > 1
                                         select new
                                         {
                                             name = empJob.Key,
                                             numOfEmployees = empJob.Count()
        ...
        public static int Task13(int[] arr)
        {
            ...
            int result = (from x in 
                                    (from d in arr
                                     from e in arr
                                     where d == e
                                     group e by e into licz
                                     where (licz.Count() % 2) != 0
                                     select new
                                     {
                                         num = licz,
                                         counter = licz.Count()
                                     })
                          select x.num).First().Key;
            //result=
            return result;
        }
